...
//  
//  if(charIndex == 92){
//  return NSControlCharacterContainerBreakAction;
//  }
//  else return NSControlCharacterLineBreakAction;
//}
- (void)layoutManager:(NSLayoutManager *)layoutManager didCompleteLayoutForTextContainer:(NSTextContainer *)textContainer atEnd:(BOOL)layoutFinishedFlag{
//  NSLog(@"complete textcontainer = %@ flag = %d",textContainer,layoutFinishedFlag);
  NSLog(@"flag = %d",layoutFinishedFlag);
  if(layoutFinishedFlag == NO && [textContainer isEqual:[self.layoutManager.textContainers lastObject]]){
    NSLog(@"Ran out of container");
//    NSLog(@"textcontainer = %@ flag = %d",textContainer,layoutFinishedFlag);
